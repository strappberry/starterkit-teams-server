        ...
        <button
            {{
                ...
                ->class([
                    ...
                    'border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $this->isTailwind && ($this->getBulkActionsButtonAttributes['default-colors'] ?? true),
