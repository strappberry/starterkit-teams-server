            ...
            <div>
                <span class="rounded-md shadow-sm">
                    <button
                        ...
                        type="button"
                        class="inline-flex justify-center px-4 py-2 w-full text-sm font-medium text-gray-700 bg-white rounded-md border border-gray-300 shadow-sm hover:bg-gray-50 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600"
                        aria-haspopup="true"
                ...
                <div class="bg-white rounded-md shadow-xs dark:bg-gray-700 dark:text-white">
                    ...
                    >
                        <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                            ...
                            >
                                <input
                                    class="text-primary-600 transition duration-150 ease-in-out border-gray-300 rounded shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600 disabled:opacity-50 disabled:cursor-wait"
                                    wire:loading.attr="disabled"
                                    type="checkbox"
                        ...
                        @foreach ($this->getColumnsForColumnSelect() as $columnSlug => $columnTitle)
                            ...
                            >
                                ...
                                >
                                    <input
                                        class="text-primary-600 rounded border-gray-300 shadow-sm transition duration-150 ease-in-out focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600 dark:focus:bg-gray-600 disabled:opacity-50 disabled:cursor-wait"
