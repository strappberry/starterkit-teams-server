    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{
            ...
            ->class([
                ...
                'border-gray-300 focus:border-primary-300 focus:ring-primary-200 dark:bg-gray-700 dark:text-white dark:border-gray-600' => $this->isTailwind && $this->getPerPageFieldAttributes()['default-colors'],
            ])
