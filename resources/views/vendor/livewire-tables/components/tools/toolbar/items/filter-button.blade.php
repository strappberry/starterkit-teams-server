...
<div @class([
    ...
    'ms-0 ms-md-2 mb-3 mb-md-0' =>
        $this->isBootstrap5 && $this->searchIsEnabled(),
            ...
            <button type="button" @class([
                ...
                @if ($count = $this->getFilterBadgeCount())
                    <span @class([
                        ...
                        'ml-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-primary-100 text-primary-800 capitalize dark:bg-primary-200 dark:text-primary-900' =>
                            $this->isTailwind,
                    ])>
                        {{ $count }}
                    </span>
