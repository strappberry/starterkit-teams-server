        ...
        <div>
            <button
                ...
                @class([
                    ...
                    'inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $this->isTailwind,
                ])
            ...
            >
                ...
                @if ($count = $this->getFilterBadgeCount())
                    <span @class([
                            ...
                            'ml-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-primary-100 text-primary-800 capitalize dark:bg-primary-200 dark:text-primary-900' => $this->isTailwind,
                        ])>
                        {{ $count }}
                    </span>
                @endif
