...
$refs.content.addEventListener('mouseleave', () => { tooltipVisible = false; });" class="relative inline-block">
    ...
    <div x-ref="tooltip" x-show="tooltipVisible"
        ...
        <div x-show="tooltipVisible" x-transition
            class="relative px-2 py-1 text-white bg-black dark:text-gray-50 dark:bg-gray-700 rounded bg-opacity-90">
